...
$/Rapid Logic/Code Line/rli_code/include/rc_startup.h

5    Schew       3/22/00   7:32p   Checked in $/Rapid Logic/Code Line/rli_code/include    
...
4    Kedron      5/27/99   8:55a   Checked in $/Rapid Logic/Code Line/rli_code/include    
...
3    Kedron      9/29/98   4:08p   Checked in $/Rapid Logic/Code Line/rli_code/include    
     Leech       8/07/98   4:28p   Labeled '2.01'                                         
2    Leech       7/30/98   1:21p   Checked in $/Rapid Logic/Code Line/rli_code/include    
1    Leech       7/27/98   6:25p   Created startup.h                                      




  */
#ifndef __STARTUP_HEADER__
#define __STARTUP_HEADER__

typedef struct Startup
{
     void (*pfuncPreInit)(void *pPreArg);
     void *pPreArg;

     void (*pfuncMsgHandlerStartup)(void);

     void (*pfuncExtraInit)(void *pArg);
     void *pArg;
