 ...
 * 
 * *****************  Version 6  *****************
 * User: Pstuart      Date: 5/09/00    Time: 5:21p
 * Updated in $/Rapid Logic/Code Line/rli_code/include
 * changed SAMPLE_AuthLevel to return type Access
 * 
 * *****************  Version 5  *****************
...
$/Rapid Logic/Code Line/rli_code/include/rc_occustom.h
...
3    Kedron      5/27/99   8:54a   Checked in $/Rapid Logic/Code Line/rli_code/include    
...
2    Kedron      8/03/98  12:33p   Checked in $/Rapid Logic/Code Line/rli_code/include    
1    Leech       7/30/98   1:01p   Created occustom.h                                     



  */

#ifndef __OCCUSTOM_HEADER__
#define __OCCUSTOM_HEADER__
...
extern Access           CUSTOM_AUTHENTICATION_LEVEL (struct environment *envVar, 
                                                     sbyte *pAuthMethod, 
                                                     sbyte *pAuthMessage);
#endif 
...
#define kDBQueryValue   1
#define kDBWriteData    2
#define kDBElementType  3
#define kDBReadData     4

extern RLSTATUS         CUSTOM_EXTERNAL_HANDLER     (ubyte type,
                                                     struct environment *p_envVar,
                                                     sbyte *pMagicMarkup, 
                                                     sbyte *pArgs, 
                                                     sbyte *pData,
                                                     sbyte *pOutputBuffer, 
