...
$History: rc_convert.h $
 * 
 * *****************  Version 18  *****************
 * User: Pstuart      Date: 7/27/01    Time: 11:18a
 * Updated in $/Rapid Logic/Code Line/rli_code/include
 * fully qualify structs
 * 
 * *****************  Version 17  *****************
 * User: Pstuart      Date: 11/17/00   Time: 7:00p
 * Updated in $/Rapid Logic/Code Line/rli_code/include
 * expanded CONVERT_Validate params, removed custom_type ifdefs --
 * shouldn't be needed anymore
 * 
 * *****************  Version 16  *****************
 * User: Pstuart      Date: 11/17/00   Time: 4:56p
 * Updated in $/Rapid Logic/Code Line/rli_code/include
 * Removed __RLI_CUSTOM_TYPE__ wrapper -- not needed. Deleted
 * CONVERT_DataLen - not used and dupe of SIZEOF_Type
 * 
 * *****************  Version 15  *****************
 * User: Pstuart      Date: 6/19/00    Time: 4:00p
 * Updated in $/Rapid Logic/Code Line/rli_code/include
 * 
 * *****************  Version 14  *****************
 * User: Pstuart      Date: 5/31/00    Time: 10:34a
 * Updated in $/Rapid Logic/Code Line/rli_code/include
 * Added RC_CONVERT_Suffix
 * 
 * *****************  Version 13  *****************
 * User: Pstuart      Date: 5/08/00    Time: 3:37p
 * Updated in $/Rapid Logic/Code Line/rli_code/include
 * Added CONVERT_AccessToStr
 * 
 * *****************  Version 12  *****************
 ...
 * 
 * *****************  Version 11  *****************
 * User: Dreyna       Date: 4/28/00    Time: 5:23p
 * Updated in $/Rapid Logic/Code Line/rli_code/include
 * Updated Custom Type call
 * 
 * *****************  Version 9  *****************
 * User: Epeterson    Date: 4/25/00    Time: 2:13p
 * Updated in $/Rapid Logic/Code Line/rli_code/include
 * Include history and enable auto archiving feature from VSS
$/Rapid Logic/Code Line/rli_code/include/rc_convert.h

8    Pstuart     4/25/00  11:28a   Checked in $/Rapid Logic/Code Line/rli_code/include    
7    Dreyna      4/19/00   5:33p   Checked in $/Rapid Logic/Code Line/rli_code/include    
6    Dreyna      4/17/00   5:56p   Checked in $/Rapid Logic/Code Line/rli_code/include    
5    Pstuart     4/11/00   2:50p   Checked in $/Rapid Logic/Code Line/rli_code/include    
4    Schew       3/22/00   7:32p   Checked in $/Rapid Logic/Code Line/rli_code/include    
...
3    Pstuart     2/17/00   1:58p   Checked in $/Rapid Logic/Code Line/rli_code/include    
...
1    Leech       7/27/98   6:24p   Created convert.h                                      
...
typedef struct DTTypeInfo
{
	...
	Access		     nAccessLevel;
	sbyte		    *pDefaultStr;
	RLSTATUS        (*pCustomValidate)(struct environment *, sbyte *, struct DTTypeInfo *, Boolean);
	DTEnumInfo	    *pEnumTable;
} DTTypeInfo;

typedef RLSTATUS ValidateHandler(struct environment *pEnv, sbyte *pData, struct DTTypeInfo *, Boolean);
...
extern RLSTATUS CONVERT_StrTypeTo(sbyte *pString, void *pDataObject, DTTypeInfo *pTypeInfo);
...
extern RLSTATUS CONVERT_Validate(struct environment *pEnv, sbyte *pString, 
                                 DTTypeInfo *pTypeInfo, Boolean errorMsg);
extern DTTypeInfo *CONVERT_TypeToInfo(DataType DType);
extern RLSTATUS CONVERT_EnumStr(DTTypeInfo *pTypeInfo, sbyte *pOutput, sbyte4 bufLen, sbyte *sep);
...
extern void     RC_CONVERT_Suffix(DTTypeInfo *pTypeInfo, sbyte *what, sbyte **start, sbyte4 *length);
