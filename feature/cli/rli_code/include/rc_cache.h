...
$/Rapid Logic/Code Line/rli_code/include/rc_cache.h
...
1    Leech       7/27/98   6:24p   Created cache.h                                        
...
typedef struct CacheObject                  /* basename:  cco */
{
    UniqId  Id;                             /* see rc_database.h */
    RLSTATUS  Dirty;                          /* has the cached object been written to */
    Boolean TempObject;                     /* is this a temp cache object (ie indexed) */
    void    *p_sdrReverseLink;              /* pointer to the structure descriptor */
    void    *pCachedItem;                   /* pointer to the item being cached */
...
extern RLSTATUS   Cache_Destruct(struct environment *p_envVar, CacheHandle **pph_cacHandle);
extern void     Cache_ObjectDirty(CacheHandle *ph_cacHand, UniqId Id);
extern void     Cache_FlushTempObjects(CacheHandle *ph_cacHand);

extern void*    Cache_FindObject(struct environment *p_envVar, CacheHandle *ph_cacHand, UniqId Id, 
                                 struct DataBaseEntry *p_dbeCell, Boolean TempObject);
