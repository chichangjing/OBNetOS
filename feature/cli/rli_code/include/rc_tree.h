...
$/Rapid Logic/Code Line/rli_code/include/rc_tree.h
...
3    Kedron      5/27/99   8:55a   Checked in $/Rapid Logic/Code Line/rli_code/include    
...
2    Jamesb      8/06/98   3:03p   Checked in $/Rapid Logic/Code Line/rli_code/include    
1    Leech       7/27/98   6:25p   Created tree.h                                         
...
/* Constants */
#define GoToLeftNode        -1
#define NodesAreEqual        0
#define GoToRightNode        1



/* Structures & Datatypes */
typedef sbyte2  TreeDir;

typedef struct  node
{
    void            *pObject;           /* pointer to data object  */
    struct  node    *pLtNode;           /* next object in the tree */
    struct  node    *pRtNode;           /* next object in the tree */

} node;

typedef struct tree
{
    struct  node*   RootOfTree;     /* pointer to the root of the tree */
...
extern void     TREE_Destruct   (tree **ppTreeRoot, 
                                 void (*funcDelete_pObject)(void *));

extern RLSTATUS TREE_AddObject  (tree *pTreeRoot, 
                                 void *pObject, 
                                 TreeDir (*funcCompare)(void *, void *));
extern RLSTATUS TREE_Traverse   (tree *pTreeRoot, 
                                 void (*funcProcessObject)(void *));

extern void*    TREE_FindObject (tree *pTreeRoot, 
                                 void *pObject, 
                                 TreeDir (*funcCompare)(void*,void*));
