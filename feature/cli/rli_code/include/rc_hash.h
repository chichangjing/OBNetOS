...
$/Rapid Logic/Code Line/rli_code/include/rc_hash.h
...
1    Leech       7/27/98   6:25p   Created hash.h                                         
...
#define kHashTableSize  97      /* Must be a prime number */
...
extern void*    HASH_Construct  (void                                               );
extern void     HASH_Destruct   (void   **ppHashTable,
                                 void   (*funcDelete_pObject)(void *pObject)        );
extern RLSTATUS HASH_AddObject  (void   *pHashTable, 
                                 void   *pObject,
                                 void   (*funcExtractKey)( void *pData, ubyte4 *pKey ),
                                 RLSTATUS (*funcCompare)(void *pObject1, void *pObject2 ) );
extern void*    HASH_FindObject (void   *pHashTable, 
                                 void   *pData,
                                 void   (*funcExtractKey)( void *pData, ubyte4 *pKey ),
                                 RLSTATUS (*funcCompare)(void *pObject1,void *pObject2 )  );
