/* rc_crc32.c -- compute the CRC-32 of a data stream
...
/* $Id: rc_crc32.c,v 1.5 1996/01/13 14:55:12 spc Exp $ */

/* For the convenience of the reader, a copy of the copyright notice is
 * presented here.  K. Wolcott */
...
/* This file was altered substantially by Kedron Wolcott to conform to 
 * ANSI standards and in a "clean-up" effort. */
...
#define kCRC32Init  0xD0B71170
static  ubyte4      mCRC32Init;
...
#ifndef __TABLES_ALLOWED__
/*-----------------------------------------------------------------------*/

static RLSTATUS 
CRC32_MakeCRCTable( void )
{
/* This code in this function was taken from makecrc.c and modified.  makecrc.c has 
...
*/
  ...
  crc_32_tab = RC_MALLOC(256*sizeof(ulg));
  if (NULL == crc_32_tab)
  ...
  /* Compute and initialize table of CRC's, five per line */
...
extern 
ulg crc32(ulg crc,			/* crc shift register */
