...
#define BRCM_HEADER_SIZE		8
#elif SWITCH_CHIP_BCM5396
#define BRCM_HEADER_SIZE		6
#else
#define BRCM_HEADER_SIZE		4
#endif

#ifndef ETH_RX_BUF_SIZE
 #define ETH_RX_BUF_SIZE         (ETH_MAX_PACKET_SIZE + BRCM_HEADER_SIZE) 
#endif
...
/* Here we configure each Ethernet driver transmit buffer to fit the Max size Ethernet
 ...
 #define ETH_TX_BUF_SIZE         (ETH_MAX_PACKET_SIZE + BRCM_HEADER_SIZE)
#endif
