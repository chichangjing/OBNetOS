...
/* Redefinition of the Ethernet driver buffers size and count */   
 ...
 #define ETH_RXBUFNB        20                  /* 10 Rx buffers of size ETH_RX_BUF_SIZE */
...
/* PHY Reset delay */ 
#define PHY_RESET_DELAY    ((uint32_t)0x0004FFFF) 
/* PHY Configuration delay */ 
#define PHY_CONFIG_DELAY   ((uint32_t)0x00FFFFFF)

/* The PHY status register value change from a PHY to another, so the user have 
   to update this value depending on the used external PHY */
#define PHY_SR    ((uint16_t)17) /* Value for 88E6095 PHY */
...
#define PHY_SPEED_STATUS            ((uint16_t)0x4000) /* Value for 88E6095 PHY */
#define PHY_DUPLEX_STATUS           ((uint16_t)0x2000) /* Value for 88E6095 PHY */
